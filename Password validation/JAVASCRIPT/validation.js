...
function strengthValidate(){
    ...
    if(Passwords.length==6){
        ...
        document.getElementById("strength-description").innerHTML="*Your Password is too small or contains not more than one uppercase letters & number*"
    }
        ...
        document.getElementById("strength-description").innerHTML="*Your password contains only one numeric value*";
        }
